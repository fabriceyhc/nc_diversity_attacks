...
# Inception V3 - https://github.com/huyvnphan/PyTorch-CIFAR10
...
def main():
    ...
    models = [resnet56, densenet121, inception_v3]
    ...
    fid_batch_size = 64
    fid_cuda = use_cuda
    real_path = "C:/temp_imgs/cifar/real_2019.10.04/"
    fake_path = "C:/temp_imgs/cifar/fake_2019.10.04/"

    with open('logs/error_log_2019.10.04.txt', 'w') as error_log: 

        for model in models:

            results = []
            model_name = model.__class__.__name__
            save_file_path = "assets/results_cifar10_" + model_name + "_2019.10.04.pkl"    
                    ...
                    for rw in reg_weights:
                        for c in confidences:
                            ...
                            try:
                                ...
                                attack_detail = ['model_name', model_name,
                                                 'timestamp', timestamp, 
