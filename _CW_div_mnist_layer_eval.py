...
## Conv2DNet
conv2dnet = Conv1DNet().to(device)
conv2dnet = get_pretrained_weights(conv2dnet)

# # Attack Time
def main():

    models = [conv1dnet, conv2dnet] # [dense5, dense10, conv1dnet, conv2dnet]
    ...
    with open('logs/error_log_2019.10.01.txt', 'w') as error_log: 

        for model in models:

            results = []
            model_name = model.__class__.__name__
            save_file_path = "assets/results_mnist_" + model_name + "_2019.10.01.pkl"    
