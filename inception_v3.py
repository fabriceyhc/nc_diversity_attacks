...
def inception_v3(pretrained=True, path='pretrained_models/cifar10/inception_v3.pt', progress=True, device='cuda', **kwargs):
    ...
    if pretrained:
        ...
        print('pretrained inception_v3 model loaded from state_dict...')
    return model
