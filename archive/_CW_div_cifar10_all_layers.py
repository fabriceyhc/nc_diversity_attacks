...
def main():
    ...
    results = []
    save_file_path = "assets/results_cifar10_2019.08.28.pkl"
    ...
    confidences = [0, 10, 20] # [15, 20, 25] # [0, 20, 40]
    ...
    fid_batch_size = 64
    fid_cuda = use_cuda
    real_path = "C:/temp_imgs/cifar/real_2019.08.28/"
    fake_path = "C:/temp_imgs/cifar/fake_2019.08.28/"

    with open('logs/error_log_2019.08.28.txt', 'w') as error_log: 
            ...
            for rw in reg_weights:
                for c in confidences:
                    ...
                    try:
                        ...
                        # adversarial attack 
                        adversaries = attack(model, target_modules, rw, inputs, targets, device, targeted, norm_type, epsilon,
